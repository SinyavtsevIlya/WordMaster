    ...
    public class SpawnTutorialWordRule : IRule
    {
        ...
        public void Initialize()
        {
            ...
            for (var characterIndex = 1; characterIndex < _alphabet.InitialWord.Length; characterIndex++)
            {
                ...
                var distance = 3;
                var position = new Vector2(characterIndex * distance + 3, Random.Range(-1f, 1f));
                ...
                arrow.transform.position = position + Vector2.left * distance * .5f;
                ...
                if (characterIndex == _alphabet.InitialWord.Length / 2)
                    hintLabel.transform.position += Vector3.right * position.x;
            }
        }
    }
}